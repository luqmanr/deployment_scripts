...
tmux send-keys -t backend-go:0 "cd /home/riset-ai/workspace/fr-backend-go/ && \
...
tmux send-keys -t backend-go:2 "cd /home/riset-ai/workspace/fr-backend-go/microservices/decode_base64/python/ && \
